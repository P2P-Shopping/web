...
import stompClient from "../../services/socketService"; // <-- Import actualizat cu ../../
...
const ListDetail: React.FC = () => {
    ...
    const handleCheck = (itemId: string) => {
        ...
        if (!stompClient.connected) {
            console.warn(
                "Offline Mode: Produsul a fost bifat local, dar nu s-a putut sincroniza cu serverul.",
            );
            return;
        }

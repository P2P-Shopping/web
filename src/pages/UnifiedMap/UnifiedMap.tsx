...
const UnifiedMap: React.FC = () => {
    ...
    const sidebarContent = (
        <SidebarView
            ...
            setIsShowingStores={setIsShowingStores}
                ...
                <div className="absolute top-4 right-4 z-[1000] flex flex-col gap-2">
                    <div className="flex bg-surface/90 backdrop-blur-md border border-border rounded-xl p-1 shadow-lg">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-tighter transition-all ${isMockGpsEnabled === false ? "bg-blue-600 text-white" : "text-text-muted hover:text-text-strong"}`}
...
interface SidebarViewProps {
    ...
    setTransportMode: (val: "driving" | "walking") => void;
    onStartRoute: (store: StoreRecommendation) => void;
    targetStoreLocation: { lat: number; lng: number } | null;
    setTargetStoreLocation: (val: { lat: number; lng: number } | null) => void;
            ...
            <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-300">
                <header>
                    ...
                    <p className="text-sm text-text-muted mt-1 leading-relaxed">
                        Select a shopping list to discover the best retail
                        locations near you.
                    </p>
                </header>
        ...
        return (
            <div className="flex flex-col gap-6 animate-in slide-in-from-right-4">
                <header className="flex flex-col gap-4">
                    <button
                        type="button"
                        onClick={() => setIsShowingStores(false)}
                            ...
                            <div className="mt-6 pt-4 border-t border-border/40 flex items-center justify-between">
                                <div className="text-xs font-bold text-text-strong flex items-center gap-4">
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        {store.transit[transportMode].timeMins}{" "}
                                        min
                                    </div>
                                    <div className="w-1 h-1 rounded-full bg-border" />
                                    <span className="text-text-muted">
                                        {store.transit[transportMode].distanceKm}{" "}
                                        km
                                    </span>
                                </div>
                                <button
        ...
        <div className="relative animate-in fade-in slide-in-from-right-4 duration-500 h-full flex flex-col">
            ...
            <div className="flex-1 overflow-hidden flex flex-col relative">
                ...
                <div className="flex-1 overflow-y-auto scrollbar-thin">
                    <ListDetail
                        isEmbedded={true}
                        listIdOverride={selectedListId ?? undefined}
                        onSwitchList={() => onListSelect("")}
                    />
                </div>

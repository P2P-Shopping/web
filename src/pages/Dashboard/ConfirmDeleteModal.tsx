...
interface ConfirmDeleteModalProps {
    ...
    error: string | null;
    onCancel: () => void;
    onConfirm: (listId: string) => void | Promise<void>;
}
        ...
        <Modal
            ...
            footer={
                <div className="grid grid-cols-2 gap-2 sm:gap-3 w-full">
                    ...
                    <button
                        type="button"
                        className="inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-2.5 bg-danger text-white border-none rounded-md text-sm font-bold transition-all hover:opacity-90 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                        onClick={async () => {
                            try {

...
export default function Navbar() {
    ...
    return (
        <nav className="relative bg-surface/80 backdrop-blur-xl border-t border-border h-16 sm:h-[72px] pb-safe flex items-center shadow-[0_-8px_30px_rgba(0,0,0,0.04)] z-[3001]">
